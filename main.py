...
def run(writer, lr=0.005, maml_lr=0.01, iterations=10, ways=5, shots=1, tps=8, fas=5, device=torch.device("cpu"), download_location='./data'): # iterations = 1000, tps = 8
    ...
    for iteration in range(iterations):
        ...
        iteration_error /= tps
        iteration_acc /= tps
        print('{} of {} - Loss : {:.3f} Acc : {:.3f}'.format(iteration, iterations, iteration_error.item(), iteration_acc))
        writer.add_scalar('Loss (iteration)', iteration_error.item(), iteration)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--iterations', type=int, default=30, metavar='N',
